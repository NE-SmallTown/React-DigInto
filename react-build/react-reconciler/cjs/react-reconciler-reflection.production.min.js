...
l.hasOwnProperty("ReactCurrentDispatcher")||(l.ReactCurrentDispatcher={current:null});l.hasOwnProperty("ReactCurrentBatchConfig")||(l.ReactCurrentBatchConfig={suspense:null});function m(b){var a=b;if(b.alternate)for(;a.return;)a=a.return;else{b=a;do{a=b;if(0!==(a.effectTag&1026))return 1;b=a.return}while(b)}return 3===a.tag?2:3}function n(b){if(2!==m(b))throw h(Error(188));}
